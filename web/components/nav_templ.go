...
func NavMenu() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!--File: views/partials/sidenav.html--><div class=\"w-56 bg-gray-800 text-white p-4\"><a href=\"/\" class=\"block py-2 px-4 text-white hover:bg-gray-600\">Home</a> <a href=\"/users\" class=\"block py-2 px-4 text-white hover:bg-gray-600\">Users</a> <a href=\"/posts\" class=\"block py-2 px-4 text-white hover:bg-gray-600\">Posts</a></div>")
		if templ_7745c5c3_Err != nil {
...
//             <img class="w-auto h-6 sm:h-7" src="/assets/images/logo.jpg" alt="logo">
//         </a>
